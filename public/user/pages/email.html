...
<body class="">
    ...
    <section class="bg_on_body ">
            ...
            <!--end:: header -->
            <!-- begin:: body -->
            <div class="container profile_details_wrapper py-5">
                <!-- begin:: body contant -->
                            ...
                            <li>
                                <div class="main_single_item d-flex  justify-content-center">
                                    <div class="email-add-fild">
                                        <h4 class="item_title pe-3"> Email Address:- </h4>
                                        <input type="email" name="email" placeholder="johndoe@gmail.com" class="mb-3">
