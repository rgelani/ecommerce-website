                    ...
                    <div>
                        ...
                        <div class="borde_left_profile_main">
                            <div class="d-flex justify-content-center profile_big_img">
                                <img src={{ asset('sellerProfile/' . $authUser->profile_avatar) }} class="img-fluid profile-pic" alt="">
                            </div>
                            ...
                            <li class="py-2">Password:- <span>bfi662@hvksci</span>
                        ...
                        <div>
                            <form class="Basic_form" id="account_password_form_id">
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    <button type="button"
                                            class="btn btn-outline-secondary save_btn">CANCEL
                                    </button>
                                    <button type="button"
