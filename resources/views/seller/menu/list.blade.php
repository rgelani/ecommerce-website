            ...
            <div class="col-12">
                <div class="content_box">
                    <div class="d-flex py-3 mb-3 align-items-center justify-content-between border-bottom">
                        ...
                        <a href="{{ route('seller.menu_create')}}" title="{{ trans('messages.actiontext.add') }}" class="btn btn-sm btn-theme-drk"><i class="icon-plus"></i>{{ trans('messages.actiontext.add') }}</a>
                    </div>
                    <div class="table-responsive">
                        <table id="menu_datatable" class="table align-middle table-row-dashed fs-7 gy-5 dataTable no-footer">
                            <thead>
