...
<div class="single_product_listing">
    ...
    <form id="product_form" method="POST">
        ...
        <div class="search_input">
            <!-- <select class="search-control" name="search_input" onchange="handleSelectChildCategory(this)">
                @foreach($child_sub_category as $cat)
                <option value="{{$cat->id}},{{$cat->sub_category_id}},{{$cat->category_id}}">{{$cat->child_sub_name}} in {{$cat->cat_name}}
                    <div>({{$cat->cat_name}} > {{$cat->sub_name}} > {{$cat->child_sub_name}})</div>
                </option>    
                @endforeach
            </select> -->
                            <div class="product-search-main">
                                <input type="text" placeholder="Search your Catagory" class="product-search-bar">
                                <div class="serach-icon">
                                    <img src="{{asset('seller-assets/image/single_product_listing/big_search.png')}}" alt="">
                                </div>
                                <div class="close-icon">
                                    <button type="button" class="btn-close" aria-label="Close"></button>
                                </div>
                            </div>
                            <ul class="ser-result-main">
                                <div class="search-resul-header">
                                    Suggested Categories
                                </div>
                                <div class="search-result-body scrollbar" id="style-3">
                                    <div class="force-overflow">
                                    @foreach($child_sub_category as $cat)
                                    <li>
                                        <a href="#" onclick="handleSelectChildCategory(this)" data-value="{{$cat->id}},{{$cat->sub_category_id}},{{$cat->category_id}}">
                                                <div>{{$cat->child_sub_name}} in {{$cat->cat_name}}</div>
                                                <div>{{$cat->cat_name}} > {{$cat->sub_name}} > {{$cat->child_sub_name}}</div>
                                        </a> 
                                    </li>  
                                    @endforeach
                                ...
                                <div class="search-result-footer">
                                    <span>Can't find category?</span> 
                                    <span><a href="#">Recommend Category</a></span>
                                </div>
                            </ul>
        </div>
        ...
        <input type="hidden" name="sub_category_id" id="category_name_first">
        <input type="hidden" name="child_sub_category_id" id="child_sub_category_id">
                        ...
                        <div class="cm_info_wrap">
                            <div class="cm_info_inner">
                                ...
                                <div class="info_dec">
                                    ...
                                    <div class="lable_input price_wrap price_wrap_with_ruupry_symbol">
                        ...
                        <div class="cm_info_wrap">
                            <div class="cm_info_inner">
                                ...
                                <div class="info_dec">
                                    ...
                                    <!-- <div class="lable_dec">
                                        <div class="dropdown mb-5">
                                            <select class="dropdown-menu single_select" style="width:calc(100% + 20px)" name="hsn_id" id="hsn_select"
                                                type="select">
                                            </select>
                                        </div>
                                    </div> -->
                                    <div class="select_wrap gst_select">
                                        ...
                                        <div class="dropdown" id="hsn_select">
                                            <button class="btn btn-secondary dropdown-toggle single_select" type="button" id="hsn_dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                                Select
                                            </button>
                                            <ul class="dropdown-menu" aria-labelledby="hsn_dropdown">
                                                <!-- Dynamic option will be set here on select of category -->
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <span id="hsn_id-error"></span>
                                <div class="info_dec">
                                    <div class="lable_dec">
                                    ...
                                    <div class="lable_input">
                                        ...
                                        <input type="text" name="hsn_code" id="hsn_code" value="{{$product->hsn_id??''}}">
                                    </div>
                                ...
                                <div class="info_dec">
                                    ...
                                    <div class="select_wrap gst_select">
                                        <input type="text" name="GST" class="d-none" value="{{isset($product->GST) ? $product->GST : ''}}">
                                        <div class="dropdown">
                                            <button class="btn btn-secondary dropdown-toggle single_select" type="button" id="gst_dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                                {{isset($product->GST) ? $product->GST : "Select" }}
                                            </button>
                                            <ul class="dropdown-menu" aria-labelledby="gst_dropdown">
                                                <li><a class="dropdown-item" data-value="3" href="#">3%</a></li>
                                                <li><a class="dropdown-item" data-value="5" href="#">5%</a></li>
                                                <li><a class="dropdown-item" data-value="12" href="#">12%</a></li>
                                                <li><a class="dropdown-item" data-value="18" href="#">18%</a></li>
                                                <li><a class="dropdown-item" data-value="28" href="#">28%</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- <div class="lable_dec">
                        ...
                        <div class="cm_info_wrap">
                            <div class="cm_info_inner">
                                <div class="info_dec mt-0">
                                    ...
                                    <div class="lable_input price_wrap mt-0 price_wrap_with_ruupry_symbol">
                                        <div class="price_text">
                                            <span>₹</span>
                                        </div>
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-6">
                        <div class="return_info_dec">
                            ...
                            <div class="select_wrap">
                                <input type="hidden" name="return_order" value="{{isset($product->return_order) && $product->return_order}}">
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle single_select" type="button" id="return_order_dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                        {{isset($product->return_order) && $product->return_order == "" ? "Select" : "Select" }}
                                        {{isset($product->return_order) && $product->return_order == "1" ? "Yes" : "" }}
                                        {{isset($product->return_order) && $product->return_order == "0" ? "No" : "" }}
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="return_order_dropdown">
                                        <li><a class="dropdown-item" data-value="" href="#">Select</a></li>
                                        <li><a class="dropdown-item" data-value="1" href="#">Yes</a></li>
                                        <li><a class="dropdown-item" data-value="0" href="#">No</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-5 col-md-6">
                        <div class="return_info_dec">
                            ...
                            <div class="select_wrap">
                                <input type="hidden" name="return_order_in_day" value="{{!isset($product->return_order_in_day) || $product->return_order_in_day == '' ? '' : $product->return_order_in_day }}">
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle single_select" type="button" id="return_order_dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                        {{!isset($product->return_order_in_day) || $product->return_order_in_day == "" ? "Select" : $product->return_order_in_day }}
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="return_order_dropdown">
                                        <li><a class="dropdown-item" data-value="" href="#">Select</a></li>
                                        <li><a class="dropdown-item" data-value="2" href="#">2</a></li>
                                        <li><a class="dropdown-item" data-value="3" href="#">3</a></li>
                                        <li><a class="dropdown-item" data-value="4" href="#">4</a></li>
                                        <li><a class="dropdown-item" data-value="5" href="#">5</a></li>
                                        <li><a class="dropdown-item" data-value="6" href="#">6</a></li>
                                        <li><a class="dropdown-item" data-value="7" href="#">7</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- <div class="select_wrap mb-4">
                    ...
                    <div class="col-md-12">
                        <div class="return_info_dec">
                            <div class="sale_wrap">
                                ...
                                <div class="lable_input price_wra price_wrap_with_ruupry_symbol">
                                    <div class="price_text">
                                        <span>₹</span>
                                    </div>
                            ...
                            <div class="start_end_date ml-4">
                                <div class="date_title_wrap">
                                    ...
                                    <div class="position-relative">
                                        <input type="date" placeholder="dd/mm/yyyy" onclick="(this.type='date')"
                                ...
                                <div class="date_title_wrap">
                                    <p>Sale End Date:</p>
                                    <div class="position-relative bootstrap-datepicker">
                                        <input type="date" placeholder="dd/mm/yyyy" onclick="(this.type='date')"
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-6">
                        <div class="return_info_dec">
                            ...
                            <div class="return_input lable_input">
...
<script>
    ...
    function makeAjaxRequest (url, onSuccess, method = "get", data = {}) {
        $.ajax({
            type: "get",
            url: url,
            data: data,
    ...
    function getCategories (elem, url) {
        $.ajax({
            type: "get",
            url: url,
            data: {},
            ...
            success: function(response) {
                if (!response.error)
                {
                    ...
                    response.forEach(element => {
                        str += `<li class="${assignClass(elem, element.id)}">
                                <a href='#0' data-menuid='${element.id}' id='${element.id}' data-menu='${element.name}'>${element.name}</a>
                            </li>`
                    });
                    str += "</ul></div>";
                    ...
                    $('.sec_menu li').click(function (e) {
                        removePreSelectedCat();
                        let classes = "category-selected right-arrow position-relative";
                        let cat_id = $(this).children('a').data("menuid")
                        let url = '{{ route('seller.product.child_sub_category', ":id") }}';
                            url = url.replace(':id', cat_id);

                        $('.sec_menu li').removeClass(classes);
                        $("#category_name_first").val(cat_id);
                        $(this).addClass(classes)
                        getCategories(".third_menu", url)
                    });
                    ...
                    $('.third_menu li').click(function (e) {
                        ...
                        let cat_id = $(this).children('a').data("menuid")
                        let url = '{{ route('seller.product.get_hsnlist', ":id") }}';
                            url = url.replace(':id', cat_id);

                        $("#child_sub_category_id").val(cat_id)
                        $('.third_menu li').removeClass(classes);
                        
                        $(this).addClass(classes);
                        makeAjaxRequest()
                        makeAjaxRequest(url, getHsnCode)
                        showSelCatPath();
                    });
                    showSelCatPath();
                }
    ...
    function getHsnCode (response) {
        if (!response.error){
            // let html = $("#hsn_select").html();
            let html = ""
            response.forEach(elem => {
                // html += `<option class="dropdown-item" value='${elem.id}'>${elem.code}</option>`
                html += `<li><a class="dropdown-item" data-value="${elem.id}" href="#">${elem.code}</a></li>`
            });
            $("#hsn_select ul").html(html);
            $("#hsn_select ul li a").click(onClickDropdown)
        }
    }

    function handleSelectChildCategory (elem) {
        let str = elem.children[0].innerText
        let searchValue = str.slice(0, str.indexOf(" In")) 
        $(".product-search-bar").val(searchValue);
        let arr = elem.dataset.value.split(",")
        searchCategory.child_sub_category_id = arr[0]
        searchCategory.sub_category_id = arr[1] 
        searchCategory.category_id = arr[2] 
        $(`[data-menuid=${arr[2]}]`).click()
        $("#child_sub_category_id").val(arr[0])
        $("#category_name_first").val(arr[1]);
        
        let url = '{{ route('seller.product.child_sub_category', ":id") }}';
            url = url.replace(':id', arr[1]);
            getCategories(".third_menu", url)
        let url2 = '{{ route('seller.product.get_hsnlist', ":id") }}';
            url2 = url2.replace(':id', arr[0]);
            makeAjaxRequest(url2, getHsnCode)
            showSelCatPath();
    }

    function assignClass (elem, id) {
        if(elem === ".sec_menu" && searchCategory.sub_category_id === id)
            return "category-selected right-arrow position-relative"
        
        if(elem === ".third_menu" && searchCategory.child_sub_category_id === id)
            return "category-selected"
    }

    function removePreSelectedCat () {
        if(Object.keys(searchCategory).length > 0){
            delete searchCategory.child_sub_category_id;
            delete searchCategory.sub_category_id; 
            delete searchCategory.category_id;  
        }
    }

    function onClickDropdown (event) {
        let gstValue = $(this).data("value");
        let gstDisplayTxt = $(this).text();
        let parentDiv = $(this).parents('div.select_wrap');
        parentDiv.children('input').val(gstValue)
        parentDiv.find('button.btn').text(gstDisplayTxt)
        showSelCatPath()
    }

    function showSelCatPath () {
        let cat = $('.first_menu li.category-selected a');
        let sub_cat = $('.sec_menu li.category-selected a');
        let child_sub_cat = $('.third_menu li.category-selected a');
        let str = ""
        if(cat){
            str += `<li><a href="#">${cat.text()}</a></li>`
        }
        if(sub_cat){
            str += `<span>></span>
                    <li><a href="#">${sub_cat.text()}</a></li>`
        }
        if(child_sub_cat){
            str += `<span>></span>
                    <li><a href="#" class="active">${child_sub_cat.text()}</a></li>`
        }
        $('.catagory_parth').html(str);
    }

    function setSearchOpt (response) {
        var str = "";
            response.forEach(element => {
                str += `<li>
                            <a href="#" onclick="handleSelectChildCategory(this)" data-value="${element.id},${element.sub_category_id},${element.category_id}">
                                    <div>${element.child_sub_name} in ${element.cat_name}</div>
                                    <div>${element.cat_name} > ${element.sub_name} > ${element.child_sub_name}</div>
                            </a> 
                        </li>`
            });

        $('.force-overflow').html(str);
    }
        ...
        $(document).ready(function(){
            ...
            $('.dropdown .dropdown-menu .dropdown-item').click(onClickDropdown);

            $('.product-search-bar').keyup(function (event) {
                let url = '{{ route('seller.product.search_child_sub_category', ["search" => "searchval"]) }}';
                url = url.replace("searchval", event.target.value);
                makeAjaxRequest(url, setSearchOpt)
            })

            $('.first_menu li').click(function (e) {
                let classes = "category-selected right-arrow position-relative";
                let cat_id = $(this).children('a').data("menuid");
                let url = '{{ route('seller.product.sub_category', ":id") }}';
                    url = url.replace(':id', cat_id);
                ...
                $(this).addClass(classes)
                $(".third_menu").html("");
                getCategories(".sec_menu", url)
            })

            $('.product_image').change(function (e) {
                let imgTag = $(this).parent().children('.previewImgs').children('.previewImg')
                imgTag.attr("src",URL.createObjectURL(e.target.files[0]))
                imgTag.css("display", "inline")
                
                $(this).parent().children('.plus_img').css("display", "none")
                e.preventDefault();
        ...
        $("#product_form").validate({
            rules: {
                ...
                // hsn_id: {
                //     required: '#hsn_code:blank'
                // },
                // hsn_code: {
                //     required: '#hsn_id:blank'
                // }
                category_id: {
                    required: true
                },
