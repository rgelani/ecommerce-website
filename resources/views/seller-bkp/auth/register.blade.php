                        ...
                        <div class="fieldset_wrap outer_height">
                            <fieldset class="fieldset_wrap_1">
                                <div class="res_common_input_wrap">
                                    ...
                                    <div class="res_input_wrap {{ @$id  ? 'ifSponsorRefer' : ''}}">
                                        <input type="text" placeholder="Sponsor id" id="sponsor_id" name="sponsor_id" value="{{ @$id }}">
                                        <input type="hidden" id="seller_sponsor_id" name="seller_sponsor_id" value="{{ @$id }}">
                            ...
                            <fieldset class="fieldset_wrap_2">
                                ...
                                <div class="res_common_input_wrap">
                                    <p class="res_input_label">Bank Name.: <span>*</span></p>
                                    <div class="res_input_wrap">
                                        <input type="text" placeholder="Bank Name" id="bank_name" name="bank_name">
                                    </div>
                                </div>
                            ...
                            <fieldset class="fieldset_wrap_4">
                                ...
                                <div class="res_common_input_wrap">
                                    <p class="res_input_label">Country:
                                    <div class="res_input_wrap">
                                ...
                                <div class="res_common_input_wrap">
                                    ...
                                    <div class="res_input_wrap">
                                        <select id="state" name="state_id" class="form-control">
                                            <option value="0" selected>Select States</option>
