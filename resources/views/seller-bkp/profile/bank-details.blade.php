                        ...
                        <div>
                            <form class="bank_details" id="bank_details_id">
                                ...
                                <div class="">
                                    ...
                                    <input type="text" name="bank_name" value="{{$authUser->bank_name}}" class="input_pading_for_half_width form-control position-relative" id="bank_name_id">
                                ...
                                <div class="">
                                    ...
                                    <input type="number" name="bank_account_number" value="{{$authUser->bank_account_number}}" class="input_pading_for_half_width form-control position-relative"
                                ...
                                <div class="">
                                    ...
                                    <input type="number" name="confirm_bank_account_number" value="{{$authUser->bank_account_number}}" class="input_pading_for_half_width form-control position-relative" id="confirm_bank_acc_number_id">
                                    {{--                                    <button class="pen_btn_name">--}}
                                    {{--                                        <img src={{asset('seller-assets/image/profile/pen_profile.png')}} alt="">--}}
                                    {{--                                    </button>--}}
                                </div>
                                <div class="">
                                    ...
                                    <input type="text" name="ifsc_code" value="{{$authUser->ifsc_code}}" class="input_pading_for_half_width form-control position-relative" id="ifsc_code_id">
                                    {{--                                    <button class="pen_btn_name">--}}
                                    {{--                                        <img src={{asset('seller-assets/image/profile/pen_profile.png')}} alt="">--}}
                                    {{--                                    </button>--}}
                                </div>
