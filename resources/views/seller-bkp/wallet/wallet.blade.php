...
@section('content')
    <div class="main_content_lg">
        ...
        <div class="w-100 main_info_wallet mt-5">
                                   ...
                                   <table class="w-100">
                                        <thead>
                                             <tr class="heading_wallet_main">
                                                  ...
                                                  <th class="dote_trasaction"> <a href="#"> <img
                                                                 src="assets/image/wallet/round_dot_transaction.png"
                                                                 alt=""></a> </th>
                                             </tr>
                                        </thead>
                                        ...
                                        <tr class="">
                                             ...
                                             <th class="download_threedot download_threedot_hide"><a href="#"><img
                                                            src="assets/image/wallet/download_wallet.png" alt=""></a>
                                             </th>
                                             </td>
                                        ...
                                        <tr class="bg_active_wallet">
                                             ...
                                             <td class="download_threedot">
                                                  <a href="">
                                                       <img src="assets/image/wallet/download_wallet.png" alt="">
                                             </td>
                                             </a>
                                             <td class="dote_trasaction">
                                                  <img src="assets/image/wallet/three_dote_wallet_info.png" alt="">
                                             </td>
                                        </tr>
                                        <tr class="">
                                             <td class="ps-1">
                                             ...
                                             <td class="dote_trasaction"><a href="#"> <img
                                                            src="assets/image/wallet/dot_bg_wallet.png" alt=""></a></td>
                                        </tr>
                                        <tr class="">
                                             <td class="ps-1">
                                                  <label class="checkbox bounce">
                                        ...
                                        <li class="d-flex justify-content-between align-items-center">
                                             <div class="m-0 ms-2 use_single_box">
                                                  <div class="m-0"><a href="#"><img
                                                                 src="assets/image/wallet/wallet_round_icon.png" alt=""
                                                                 class="  "></a></div>
                                   ...
                                   <div class="w-100 m-0 pe-1">
                                        ...
                                        <ul class="m-0 p-0 w-100 main_monthly_list">
                                             <li class="d-flex justify-content-between align-items-center">
                                                  <div class="m-0 ms-2 use_single_box">
                                                       <div class="m-0"><a href="#"><img
                                                                      src="assets/image/wallet/wallet_history_1.png"
                                                                      alt="" class="  "></a></div>
                                                       <div class="m-0  use_for_marketing">
                                             ...
                                             <li class="d-flex justify-content-between align-items-center">
                                                  <div class="m-0 ms-2 use_single_box">
                                                       <div class="m-0"><a href="#"><img
                                                                      src="assets/image/wallet/wallet_history_2.png"
                                                                      alt="" class="  "></a></div>
                                                       <div class="m-0  use_for_marketing">
                                                            <p>Deposit UPI</p>
                                                            <span class="date_marketing">5 march, 18:33</span>
                                             ...
                                             <li class="d-flex justify-content-between align-items-center">
                                                  <div class="m-0 ms-2 use_single_box">
                                                       <div class="m-0"><a href="#"><img
                                                                      src="assets/image/wallet/wallet_history_3.png"
                                                                      alt="" class="  "></a></div>
                                                       <div class="m-0  use_for_marketing">
                                             ...
                                             <li class="d-flex justify-content-between align-items-center">
                                                  <div class="m-0 ms-2 use_single_box">
                                                       <div class="m-0"><a href="#"><img
                                                                      src="assets/image/wallet/wallet_history_4.png"
                                                                      alt="" class="  "></a></div>
                                                       <div class="m-0  use_for_marketing">
                                                            <p>Cancelled</p>
                                                            <span class="date_marketing">5 march, 18:33</span>
                                             ...
                                             <li class="d-flex justify-content-between align-items-center">
                                                  <div class="m-0 ms-2 use_single_box">
                                                       <div class="m-0"><a href="#"><img
                                                                      src="assets/image/wallet/wallet_history_5.png"
                                                                      alt="" class="  "></a></div>
                                                       <div class="m-0  use_for_marketing">
                                                            <p>Use For Markentig</p>
                                                            <span class="date_marketing">5 march, 18:33</span>
                                        ...
                                        <div class="w-100 m-0 me-1">
                                             ...
                                             <ul class="m-0 p-0 pe-1 w-100  main_monthly_list">
                                                  <li class="d-flex justify-content-between align-items-center">
                                                       <div class="m-0 ms-2 use_single_box">
                                                            <div class="m-0"><a href="#"><img
                                                                           src="assets/image/wallet/wallet_profile_dp.jpg"
                                                                           alt="" class="  "></a></div>
                                                            <div class="m-0  use_for_marketing">
                                                                 <p>Seller Name</p>
                                                                 <span class="date_marketing">5 march, 18:33</span>
                ...
                <div class="modal-header">
                    <div>
                        <div class="main_add_money_to_wallet">
                            <p>Directly Add money to Campaign</p>
                            <ul class="outstanding_model_wallet">
                                <li>Total Outstanding balance: <span>Rs.5000</span></li>
                                <li>Total Wallet balance: <span>Rs.{{ $totalWalletBalance ?? 0 }}</span></li>
                            </ul>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <div class="amount_model_main pb-3">
                                    <p>Amount</p>
                                    <div class="">
                                        <input type="number" id="amount" oninput="validity.valid||(value='');"
                                            class="enter_amount_popup form-control" name="outstanding_amount"
                                ...
                                <div>
                                    <div>
                                        <ul class="box_main_amout_model razor-pay-btn">
                                            <button>
                                                <img src="{{ asset('seller-assets/image/razorpay_btn_img.png') }}"
                            ...
                            <div>
                                <div class="amount_model_main justify-content-end pb-3">
                                    <p>Add Amount To Campaign</p>
                                    <div class="">
                                        <input type="number" id="outstanding_amount"
                                            oninput="validity.valid||(value='');" class="enter_amount_popup form-control"
                                            name="outstanding_amount" value="{{ old('outstanding_amount') }}"
                                            autocomplete="off" placeholder="Enter your amount....." />
                                    </div>
                                </div>
                                <div class="main_pay_btn_model text-end me-3"><a href="#" id="add-campaign-amount"
                                        class="">Add</a>
                                </div>
                            </div>
                        </div>
