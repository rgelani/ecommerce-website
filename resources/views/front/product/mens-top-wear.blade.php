...
<head>
    ...
    <style>
        .ui-widget-header {
            border: 1px solid #137ebd !important;
            background: #137ebd !important;
        }
    </style>
</head>
...
<body>
    ...
    <!-- begin:: banner -->
    <section class="main-mens-title-section">
        <div class="container">
    ...
    <section class="categories-filter-section">
        <div class="categories-filter-row ">
            <!-- begin:: filter section -->
            <div class="categories-filter-left-col d-none d-xl-block" data-aos="fade-right">
                <div class="left-filter-btn">
                    <a href="#" class="btn">
                        <span>
                            <svg width="28" height="18" viewBox="0 0 28 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" width="27" height="3" fill="#4FC6AF" />
                                <rect x="5" y="7.5" width="18" height="3" fill="#4FC6AF" />
                                <rect x="11" y="15" width="6" height="3" fill="#4FC6AF" />
                            </svg>
                        </span>
                        <h5>Filter</h5>
                    </a>
                </div>
                <div class="left-categories-title">
                    <h4>CATEGORIES</h4>
                </div>
                <div class="left-mobile-accessories d-flex align-items-center flex-wrap categories-list">
                    <span>
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M7.83263 13.8423C7.60948 14.0526 7.24767 14.0526 7.02451 13.8423L0.167369 7.38075C-0.0557884 7.17047 -0.0557884 6.82953 0.167369 6.61925L7.02451 0.157711C7.24767 -0.0525704 7.60948 -0.0525704 7.83263 0.157711C8.05579 0.367994 8.05579 0.708928 7.83263 0.919211L1.37955 7L7.83263 13.0808C8.05579 13.2911 8.05579 13.632 7.83263 13.8423Z"
                                fill="black" fill-opacity="0.6" />
                        </svg>
                    </span>
                    <h5>Men’s Topwear</h5>
                    <h3>Men’s Topwear</h3>
                    <ul class="mens-top-wear">
                        <li>All</li>
                        <li>T-shirts</li>
                        <li>Casual Shirts</li>
                        <li>Formal Shirts</li>
                ...
                <div class="accordion left-accordion-filter" id="accordionExample">
                    <div class="accordion-item" id="acc-price">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseOne" aria-expanded="true"
                                aria-controls="collapseOne">PRICE</button>
                        </h2>
                            ...
                            <div class="accordion-body">
                                <div data-role="rangeslider">
                                    <p>
                                     ...
                                     <div id = "slider-3"></div>
                                    <div class="left-min-max">
                                    </div>
                                    <div class="min-max-input">
                                        <input placeholder="Min" type="number" id="min-range">
                                        <span>To</span>
                                        <input placeholder="Max" type="number" id="max-range">
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="other-filter"></div>
                </div>
            </div>
            <!-- end:: filter section -->
            <!-- begin::product section -->
            <div class="categories-filter-right-col" >
                <div class="categories-mens-product-details">
                    <div class="categories-filter-path ">
                        <ul>
                            <li><a href="#">Home</a></li>
                    ...
                    <!-- begin::res filter popup -->
                    <div>
                        <!-- begin::res filter button -->
                        <div class="left-filter-btn responsive-filter-btn d-xl-none">
                            <a href="#" class="btn">
                                <span>
                                    <svg width="28" height="18" viewBox="0 0 28 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- end::res filter button -->
                        <!-- begin::res filter section -->
                        <div class="responsive-category  d-xl-none">
                            <div class="left-categories-title">
                                <h4>CATEGORIES</h4>
                            </div>
                            <div class="left-mobile-accessories d-flex align-items-center flex-wrap categories-list">
                                ...
                                <h5>Men’s Topwear</h5>
                                <h3 class="w-100">Men’s Topwear</h3>
                                <ul class="mens-top-wear">
                                    <li>All</li>
                                    <li>T-shirts</li>
                                    <li>Casual Shirts</li>
                        ...
                        <!-- end::res filter section -->
                    </div>
                    <!-- end::res filter popup -->
                ...
                <div class="tab-view">
                    ...
                    <div class="tab_container" >
                        <div id="tab1" class="tab_content" style="display: block;">
                            <div class="categories-filter-item" id="categories-product-filter"></div>
                        </div>
                        <div id="tab2" class="tab_content" style="display: none;">
                            <div class="categories-filter-item">
                                <div class="categories-item-top">
                                    <div class="categories-item-save">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="22"
                                            viewBox="0 0 16 22" fill="none">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M2 1.74988C1.86193 1.74988 1.75 1.86181 1.75 1.99988V19.6853L7.10947 16.5171C7.65876 16.1924 8.34124 16.1924 8.89053 16.5171L14.25 19.6853V1.99988C14.25 1.86181 14.1381 1.74988 14 1.74988H2ZM0.25 1.99988C0.25 1.03338 1.0335 0.249878 2 0.249878H14C14.9665 0.249878 15.75 1.03338 15.75 1.99988V20.1235C15.75 21.0915 14.6972 21.6921 13.8639 21.1995L8.12722 17.8084C8.04875 17.762 7.95125 17.762 7.87278 17.8084L2.13609 21.1995C1.30282 21.6921 0.25 21.0915 0.25 20.1235V1.99988Z"
                                    ...
                                    <div class="categories-item-description">
                                        <h2>Redmi Note 10s (Deep Sea Blue, 64 GB)</h2>
                                        ...
                                        <ul>
                                            ...
                                            <li>64MP + 8MP + 2MP + 2MP | 13MP Front Camera</li>
                                            <li>5000 mAh Lithium-Ploymer Battery</li>
                                            <li>Mediatek Helio G95 Processor</li>
                                            <li>1 Year Manufacturer Warranty for phone and 6 Months Warranty for In the
                                                Box Accessories</li>
                                        </ul>
                                    </div>
                                    <div class="categories-item-price">
                                        <div class="categories-main-price">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="37"
                                                    viewBox="0 0 16 37" fill="none">
                                                    <path
                                        ...
                                        <div class="categories-sub-price">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="37"
                                                    viewBox="0 0 16 37" fill="none">
                                                    <path
            ...
            <!-- begin:: pagination -->
            <div class="categories-filter-tabs pt-4 col-12">
            </div>
            <!-- end:: pagination -->
        </div>
    </section>
    <!-- end:: body -->
    <!-- begin:: shipping footer -->
    <section class="shipping-section">
        <div class="container-small">
            <div class="shipping-row">
                <div class="shipping-col ">
                    <div class="shipping-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="81" height="50" viewBox="0 0 81 50" fill="none">
                            {{-- https://www.instagram.com/reel/Cm_kjJohJpA/?next=%2F --}}
                            <path
                ...
                <div class="shipping-col mt-md-4 mt-xl-0">
                    <div class="shipping-icon">
    ...
    <script>
        ...
        function getProducts(page = 1){
            ...
            $.ajax({
                type: "POST",
                url: '{{ route('filter-mens-top-wear') }}',
                data: {
                    page: page,
                    category_id: urlParams.get('category_id'),
                    sub_category_id: urlParams.get('sub_category_id'),
                    price: $('#min-range').val() + '-' + $('#max-range').val(),
                ...
                success: function (response) {
                    ...
                    $('#categories-product-filter').empty().html(response.html);
                    $('.categories-filter-tabs').empty().html(paginate.html);
                    $('.filter-product-count').html(paginate.filter_count);
                    $('.categories-list').html(response.categories);
                    $('.other-filter').empty().html(response.filters)
                },
        ...
        function getFilters(){
            let filters = {};
            $('.chk_filters:checked').each(function(i){
