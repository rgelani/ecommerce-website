                                    ...
                                    <div class="order-list">
                                        ...
                                        <div class="row order-table justify-content-between ptb-30">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-3 cancel-need-help">
                                                ...
                                                <ul class="pt-20 cancel-need-btn">
                                                    <li  class="pt-10 d-flex" style="color: #FF0000; font-weight: 700;">
                                                        <p>
                                                            <i class="fa fa-times-circle-o" aria-hidden="true"></i>
                                                        </p>
                                                        <span>Cancel</span>
                                                    </li>
                                                    <li class="pt-20 d-flex" style="color: #2A4CFF; font-weight: 700;">
                                                        <p>
