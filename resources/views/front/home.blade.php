...
@section('content')
    ...
    <div class="login-page main-login-page col-10 m-auto">
        <div class="login-form-main">
            <li class="sub-cat"><a href="#" class="category_items">All</a>
                                    </li>
                                    <li class="sub-cat"><a href="#" class="category_items">Men's
                                            T-Shirts</a>
                                    </li>
                                    <li class="sub-cat"><a href="#" class="category_items">Men's
                                            Casual
    ...
    @if(isset($bannerImages['top']))
        @include('front.home.banner-top')
    @endif
                ...
                <div class="crazy-deals-col">
                    <div class="crazy-deals-inner">
                        <div class="crazy-deals-content">
                            <img src="assets/images/realme-c21y-1.png">
                        </div>
                    </div>
                </div>
                <div class="crazy-deals-col">
                    <div class="crazy-deals-inner">
                        <div class="crazy-deals-content">
                            <img src="assets/images/realme-c21y-2.png">
                        </div>
                    </div>
                </div>
                <div class="crazy-deals-col">
    ...
    @if(isset($bannerImages['center']))
        @include('front.home.banner-center')
    @endif
        ...
        <div class="migh-interested-container">
            ...
            <div class="migh-interested-slider first-interested-slider">
                <div class="migh-interested-col">
                    <div class="migh-interested-inner">
                        <div class="migh-interested-image">
                            <img src="assets/images/musical-amplifiers-1.png" alt="">
                        </div>
                        <div class="migh-interested-content">
                            <h2>Musical Amplifiers</h2>
                            <h4>Upto 50% off</h4>
                ...
                <div class="migh-interested-col">
                    <div class="migh-interested-inner">
                        <div class="migh-interested-image">
                            <img src="assets/images/musical-amplifiers-2.png" alt="">
                        </div>
                        <div class="migh-interested-content">
                            <h2>Musical Amplifiers</h2>
                            <h4>Upto 50% off</h4>
                ...
                <div class="migh-interested-col">
                    <div class="migh-interested-inner">
                        <div class="migh-interested-image">
                            <img src="assets/images/musical-amplifiers-3.png" alt="">
                        </div>
                        <div class="migh-interested-content">
                            <h2>Musical Amplifiers</h2>
                            <h4>Upto 50% off</h4>
                ...
                <div class="migh-interested-col">
                    <div class="migh-interested-inner">
                        <div class="migh-interested-image">
                            <img src="assets/images/musical-amplifiers-4.png" alt="">
                        </div>
                        <div class="migh-interested-content">
                            <h2>Musical Amplifiers</h2>
                            <h4>Upto 50% off</h4>
                ...
                <div class="migh-interested-col">
                    <div class="migh-interested-inner">
                        <div class="migh-interested-image">
                            <img src="assets/images/musical-amplifiers-5.png" alt="">
                        </div>
                        <div class="migh-interested-content">
                            <h2>Musical Amplifiers</h2>
                            <h4>Upto 50% off</h4>
    ...
    @if(isset($bannerImages['bottom']))
        @include('front.home.banner-bottom')
    @endif
        ...
        <div class="featured-brands-row">
            <div class="featured-brands-col">
                <div class="featured-brands-image">
                    <img src="assets/images/featured-brands-1.png" alt="">
                </div>
            ...
            <div class="featured-brands-col">
                <div class="featured-brands-image">
                    <img src="assets/images/featured-brands-2.png" alt="">
                </div>
                <div class="featured-brands-inner">
                    <a href="#">
                        <span>70% OFF</span>
            ...
            <div class="featured-brands-col">
                <div class="featured-brands-image">
                    <img src="assets/images/featured-brands-3.png" alt="">
                </div>
                <div class="featured-brands-inner">
                    <a href="#">
                        <span>70% OFF</span>
            ...
            <div class="featured-brands-col">
                <div class="featured-brands-image">
                    <img src="assets/images/featured-brands-4.png" alt="">
                </div>
                <div class="featured-brands-inner">
                    <a href="#">
                        <span>70% OFF</span>
    ...
    <!-- begin::top brand for fashion -->
    <!-- <section class="top-brands-section">
        <div class="top-brands-title">
            <h2>TOP BRANDS FOR FASHION</h2>
        </div>
        <div class="top-brands-row">
            <div class="top-brands-col">
                <div class="top-brands-image">
                    <img src="assets/images/top-brands-section-1.png" alt="">
                </div>
            </div>
            <div class="top-brands-col">
                <div class="top-brands-image">
                    <img src="assets/images/top-brands-section-2.png" alt="">
                </div>
            </div>
            <div class="top-brands-col">
                <div class="top-brands-image">
                    <img src="assets/images/top-brands-section-3.png" alt="">
                </div>
            </div>
            <div class="top-brands-col">
                <div class="top-brands-image">
                    <img src="assets/images/top-brands-section-4.png" alt="">
                </div>
            </div>
            <div class="top-brands-col">
                <div class="top-brands-image">
                    <img src="assets/images/top-brands-section-5.png" alt="">
                </div>
            </div>
            <div class="top-brands-col">
                <div class="top-brands-image">
                    <img src="assets/images/top-brands-section-6.png" alt="">
                </div>
            </div>
            <div class="top-brands-col">
                <div class="top-brands-image">
                    <img src="assets/images/top-brands-section-7.png" alt="">
                </div>
            </div>
        </div>
    </section> -->
    <!-- end::top brand for fashion -->
    ...
    <!-- Begin:: backto top arrow -->
    <div class="backto-top-arrow">
        <a href="#">Back to Top</a>
    </div>
    <!-- End:: backto top arrow -->
@endsection