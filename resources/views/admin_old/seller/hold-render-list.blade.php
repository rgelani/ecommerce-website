        ...
        <div class=" seller_single_box mx-2">
            <div class="d-flex justify-content-end">
                <label class="checkbox bounce">
                    <input type="checkbox" id="seller_hold" value="{{ $seller->id }}" class="seller_hold"
                        name="seller_hold" />
            ...
            <div class="d-flex profile_main_photo_seller ">
                ...
                <ul class="d-flex align-items-end mb-4 ps-0 mb-0">
                    <div>
                        <a href="#"
                            class="seller_approval_bnt text-dark fw-bolder deactive_seller ms-5 mb-0 d-flex align-items-center justify-content-center single_hold_seller"
                            data-id="{{ $seller->id }}">Hold Seller</a>
                    </div>
                </ul>
            </div>
        </div>
...
<div class="pagination_and_button d-flex justify-content-between mt-5  align-items-center">
    ...
    <div class="d-flex">
        <a href="javascript:;"
            class="seller_approval_bnt deactive_seller mb-0 d-flex  align-items-center text-dark justify-content-center multiple_hold_seller"
            data-id="{{ $seller->id }}">Hold Seller</a>
    </div>
</div>
