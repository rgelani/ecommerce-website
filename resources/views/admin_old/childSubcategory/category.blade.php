    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid mt-5" >
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Child Sub Category</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="row category-table categoryBox">
            <div class="col-md-12">
                <div class="row">
                <form action="{{ route('admin.childsubcategory.create') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card">
...
<script type="text/javascript">
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.childsubcategory.index') }}",
        columns: [
