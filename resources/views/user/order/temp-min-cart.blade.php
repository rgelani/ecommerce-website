    ...
    <div class="bg_header">
        <div class="container">
            <div class="row justify-content-between order-md-1 order-sm-1 align-items-center">
                <div class="col-lg-3 col-md-6 col-sm-4 py-lg-0 py-2 order-lg-1 ">
                    <div class="logo_main d-flex align-items-center justify-content-start">
                        <img src="image/index_home_page/home_index_logo.jpg" alt="" class="img-fluid">
                    ...
                    <ul
                        ...
                        <li>
                            <div class="cart_icon_main">
                                <img src="image/index_home_page/cart_icon_hart.png" alt="">
                                <p> <a href="#" class="header_shoping_icon">Wishlist</a> </p>
                            </div>
                        </li>
                        <li>
                            <div class="cart_icon_main">
                                <img src="image/index_home_page/cart_icon_shop.png" alt="">
                        ...
                        <li>
                            <div class="cart_icon_main">
                                <img src="image/index_home_page/cart_icon_user.png" alt="">
            ...
            <div class="row">
                <div class="col-xl-8 col-sm-12 min-cart-left-col">
                    ...
                    <div class="main-cart-item row ">
                        <div class="cart-item-left-col">
                            <div class="cart-item-image">
                                <img src="image/min-cart/min-cart-item-image.png" alt="Min Cart Items">
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <div class="place-order-content justify-content-center  d-flex align-items-center">
                        <a href="forn.html" class="btn ">PLACE ORDER</a>
                    </div>
                </div>
