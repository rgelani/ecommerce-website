            ...
            <div class="container">
                <div class="main-pdp-row">
                    ...
                    <div class="main-pdp-left-col" data-aos="fade-right">
                        ...
                        @foreach (explode(',', $product->productImage?->src) as $prod_image)
                            <div class="main-pdp-item">
                                <div class="main-slider-image">
                                    <img src="/storage/product/{{$prod_image}}" alt="Main PDP">
                                </div>
                            </div>
                        @endforeach
                        </div>
                    ...
                    <div class="main-pdp-right-col" data-aos="fade-left">
                        ...
                        <div class="main-pdp-praice">
                            <div class="main-praice"><span>₹</span>{{$product->selling_price}}</div>
                            <span class="main-praice-del">₹<del>{{$product->MRP}}</del></span>
                            <span class="off">{{ round(100 / 100 * 100) }}% off</span>
                        ...
                        <div class="main-pdp-listing-row">
                            <div class="main-pdp-listing-col pb-xl-3">
                                ...
                                <div class="main-pdp-list-btn">
                                    <ul>
                                        @foreach (explode(',', $product->key_features) as $value)
                                            <li>{{$value}}</li>
                                        @endforeach
                                    </ul>
                                    <a href="#"
                            ...
                            <div class="main-pdp-listing-col">
                                ...
                                <div class="main-pdp-list-btn meta-tag ">
                                    <ul>
                                        @foreach (explode(',', $product->meta_tags) as $value)
                                            <li>{{$value}}</li>
                                        @endforeach
                                    </ul>
                        ...
                        <div class="main-pdp-btns">
                            <a onclick="addToCart()" class="add-to-cart-btn">ADD TO CART</a>
                                ...
                                @foreach ($product->variants as $value)
                                    <li>
                                        <label>
                                            ...
                                            <span style="background-color: <?php echo $value->color; ?>;"></span>
                                        </label>
                                    </li>
                                @endforeach
                            </ul>
                ...
                <div class="main-content-seller">
                    ...
                    <div class="main-vikash-store-inner">
                        <div class="main-vikash-store">
                            <h3>{{$product->seller->company_name}}</h3>
                            <div class="main-pdp-star">
                                <span>4.3</span>
                                <div class="pdp-star">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12"
                                ...
                                <div class="accordion-body">
                                    <div class="main-description-inner">
                                        ...
                                        <div class="description-col-left scrollbar">
                                            <p class="force-overflow">{!! $product->description !!}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section class="migh-interested-section second-interested-section">
    <div class="migh-interested-container">
        ...
        <div class="migh-interested-slider second-interested-slider">
            @foreach ($similar_products as $prod_image)
                <div class="migh-interested-col">
                    <div class="migh-interested-inner">
                        <div class="migh-interested-image">
                            <img src="/storage/product/{{explode(',', $prod_image->productImage?->src)[0]}}" alt="">
                        </div>
                        <div class="migh-interested-content">
                            <h2>{{$prod_image->title}}</h2>
                            <a href="{{ route('product_view', ['id' => $prod_image->id]) }}" class="btn">Shop Now</a>
                        </div>
                    </div>
                </div>
            @endforeach
            ...
            <div class="col-lg-3 col-sm-12 col-12 col-8  ">
                <div class="footer-widget">
                    <div class="footer-logo">
                        <a href="#" class="d-flex justify-content-center"><img src="assets/images/ik_footer_logo.png"
                                class="img-fluid col-7 col-md-3" alt="logo"></a>
                    </div>
...
@section('extra-js')
    <script>
        function addToCart () {
            let url = "{{route('add_to_cart', ['productid' => $product->id])}}";
