            ...
            @if(count($response) === 0)
                <div class="row">
                    <div class=" min-cart-left-col">
                        ...
                        <div class="quantity-box-content text-center align-items-center custum_padding empty-cart-padding">
                            <div class="empty-card-image">
                                <img src="{{ asset('user/user-assets/images/empty-cart.png') }}" alt="">
                            </div>
                            <div class="empty-cart-contant">
                                <h3>Your card is empty!</h3>
                                <p>It’s good day to buy the items you saved for later!</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="main-cart-item row ">
                            <div class="cart-item-left-col">
                                <div class="cart-item-image">
                                    <img src="/storage/product/{{explode(',', $value->products->productImage->src)[0] }}" alt="Min Cart Items">
                                </div>
                            </div>
                            <div class="col">
                                <div class="min-cart-content row">
                                    <div class="col-6">
                                        <h5>{{$value->products->title}}</h5>
                                        <h6>{{$value->products->brand_name}}</h6>
                                        <h6>{{$value->products->manufacturer}}</h6>
                                    </div>
                                    ...
                                    <div class="pri-inner d-flex align-items-center">
                                        <span class="rel-pri">${{$value->products->selling_price * $value->quantity}}</span>
                                        <del class="delete-pri">${{$value->products->MRP * $value->quantity}}</del>
                        ...
                        <div class="quantity-box-content d-flex align-items-center custum_padding">
                            <div class="quantity-box d-flex align-items-center">
                                <a href="{{route('add_quantity', ['productid' => $value->product_id])}}" class="plus">+</a>
                                <input type="text" value="{{$value->quantity}}">
                                <a href="{{route('remove_quantity', ['productid' => $value->product_id])}}" class="minus">-</a>
                            </div>
                            <a href="#" class="save-for-later">SAVE FOR LATER</a>
                            <a href="{{route('remove_from_cart', ['productid' => $value->product_id])}}" class="remove">REMOVE</a>
                        </div>
                        @endforeach
                        <div class="place-order-content justify-content-center  d-flex align-items-center">
                            <a href="{{route('placeOrder')}}" class="btn ">PLACE ORDER</a>
                        </div>
                        </div>
                            ...
                            <div class="cart-inner">
                                ...
                                <div class="main-cart-right">
                                    <div class="cart-right-pri">
                                        <h6>Price ({{$total->total_quantity}} items)</h6>
                                    ...
                                    <div class="cart-right-pri">
                                        ...
                                        <span>${{$total->total_delivery_charges}}</span>
                                    </div>
                                    <div class="cart-total-pri">
                                        <h6>Total Amount</h6>
                                        <span>${{$total->total_price + $total->total_delivery_charges}}</span>
                                    </div>
