            ...
            <table role="presentation"
                ...
                <tr style="border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;">
                    <td align="left" style="padding:10px 25px;background:#fff; display: flex; align-items: center;">
                        <span style="font-weight: bold; padding-top: 10px;"> Welcome to I-Kart Online Shopping Platforms </span>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td style="padding:0 0 36px 0;color:#153643;">
                                    ...
                                    <p
                                        ...
                                        We've received a request to verification of your email.
                                    </p>
                                    <p
                                        style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                        Your verification code is mention below:
                                    </p>

                                    <p style="text-align: center; font-size:35px;" class="btn">
                                        {{ $mailDetails['otp'] }}
                                    </p>
