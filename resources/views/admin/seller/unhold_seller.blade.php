...
<div class="product_view_rating">
                              ...
                              <div class="pagination_and_button d-flex justify-content-between mt-5  align-items-center">
                                   <nav aria-label="pagination_navigation Page navigation example w-50 mb-0">
                                   ...
                                   <div class="d-flex">
                                        <a href="{{ route('admin.seller.hold-seller') }}"
                                             class="seller_approval_bnt deactive_unhold_seller mb-0 d-flex  align-items-center text-dark justify-content-center">Hold Seller</a>
