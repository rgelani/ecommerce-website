 ...
 <div class="product_view_rating">
                              ...
                              <!-- End profile -->
                               ...
                               <div class="pagination_and_button d-flex justify-content-between mt-5  align-items-center">
                                   ...
                                   <div class="d-flex">
                                        <a href="#" class="seller_approval_bnt mb-0 d-flex align-items-center justify-content-center  text-dark mb-3 me-4">Approve
                                             Seller</a>
                                        <a href="deactive_seller.html" class="seller_approval_bnt deactive_seller mb-0 d-flex align-items-center text-dark justify-content-center">Deactivate
                                             Seller</a>
                                   </div>
                              </div>
