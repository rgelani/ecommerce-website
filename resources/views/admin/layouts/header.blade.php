                              ...
                              <ul>
                                  <li>
                                      <div class="top_right_icon">
                                          <img src="{{ asset('admin/image/search_big_icon.png') }}" alt="icon">
                                      </div>
                                  </li>
                                  <li>
                                      <div class="top_right_icon cart_wrap">
                                          <img src="{{ asset('admin/image/cart.png') }}" alt="icon">
                                      </div>
                                  </li>
                                  <li>
                                      <div class="top_right_icon notification_wrap">
                                          <img src="{{ asset('admin/image/bell.png') }}" alt="icon">
                                      </div>
                                  </li>
                                  <li>
                                      <div class="top_right_icon" type="button" data-bs-toggle="modal"
                                          data-bs-target="#exampleModal">
                                          <img src="{{ asset('admin/image/account.png') }}" alt="icon">
                                      </div>
                                  </li>
                                  <li>
                                        ...
                                        <div class="modal-header">
                                             ...
                                             <div class="profile_model_info">
                                                  <div>
                                                       ...
                                                       <img src="{{ asset('admin/image/account.png') }}" class="profile_img_round" alt="">
                                                       </div>
