        ...
        <div class="product_view" style="height: 1000px;">
            ...
            <div class="single_pro_listing">
                <ul class="d-flex px-0">
                    <a class="fs-7 single_product_title border_title" href="{{route('admin.product_approval.index')}}">
                        Single product Listing
                        <span class="yellow_pricing">48</span>
                    </a>
                    <a class="fs-7 d-inline single_product_title " href="{{route('admin.product_approval.bulk_product_approval')}}">
...
@section('extra-js')
    ...
    {!! $dataTable->dom("<'entries-searchBox d-flex justify-content-between align-items-center pt-0 pb-3'<'category-entries'l><'category-searchBox'f>>r" .
        "t" .
        "<'category-footer mt-3 d-flex align-items-center justify-content-between'<'showing-category-entries'i><'category-pagination'<'custom-pagination pagination-secondary pagination align-items-stretch'p>>>")->scripts() !!}
    <script>
