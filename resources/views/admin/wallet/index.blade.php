        ...
        <div class="d-flex  py-5 justify-content-end me-5 pe-5">
            <div class="w-25 justify-content-start">
                <div class="input-group">
                    <input type="text" class="form-control marketing_camping_search pl-0 border-left-0 " placeholder="Seller_Id or Email or Mobile" aria-label="Seller_Id or Email or Mobile">
                </div>
            </div>
        </div>
